...
Per consultare la documentazione: scaricare la repository, aprire il terminale, accedere alla cartella "IS2021-G20/API"  e digitare il comando "npm start" e poi accedere al seguente url:
